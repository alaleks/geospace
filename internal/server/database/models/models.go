...
type (
	City struct {
		...
		NameASCII        string  `db:"name_ascii" json:"name_ascii"`     // Name of the city ASCII
		AlternativeNames string  `db:"alternative_names"  json:"-"`      // Alternative names of the city
		CountryCode      string  `db:"country_code" json:"country_code"` // Code of country with this city located
		Country          string  `db:"country" json:"country"`           // Name of the country with this city located
		Timezone         string  `db:"timezone" json:"timezone"`         // Name of the timezone with this city located
		CreatedAt        int64   `db:"created_at"  json:"-"`             // Date when the city was created formated by Unix timestamp
